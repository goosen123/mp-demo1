...
import com.goosen.commons.model.request.user.UserAttrReqData;
...
public class UserController extends BaseController{
	...
	public BaseCudRespData<String> add(@Validated @RequestBody UserAttrReqData reqData) throws Exception {
	...
	public BaseCudRespData<String> update(@Validated @RequestBody UserAttrReqData reqData) {
    ...
    public UserRespData getDetail(@ApiParam(name="id",value="用户id",required=true)String id) throws Exception {
    ...
    public PageInfo<UserRespData> getListByPage(@ApiParam(name="pageNum",value="当前页数")Integer pageNum,@ApiParam(name="pageSize",value="页大小")Integer pageSize,@ApiParam(name="attrName",value="商品属性名称")String attrName) throws Exception {
